...
from graphgps.layer.neural_atoms import NeuralAtom
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        elif global_model_type == 'NeuralAtom':
            # TODO: Add config parameter for number_atoms.
            self.self_attn = NeuralAtom(emb_size_atom=dim_h, num_hidden=1, number_atoms=100000)
        else:
    ...
    def forward(self, batch):
        ...
        if self.self_attn is not None:
            ...
            elif self.global_model_type == 'NeuralAtom':
                h_attn = self.self_attn(h, batch.batch)
            else:
